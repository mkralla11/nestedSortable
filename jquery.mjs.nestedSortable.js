	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		_create: function() {
			...
			if(listClass.length){
				...
				throw new Error('nestedSortable: The listClass was not specified.');		
			}
      ...
      // To find the previous sibling in the list, keep backtracking until we hit a valid list item.
			...
			if (previousItem != null) {
				...
				while (!previousItem.hasClass(this.options.itemClass) || previousItem[0] == this.currentItem[0] || previousItem[0] == this.helper[0]) {
      ...
      if (nextItem != null) {
        while (!nextItem.hasClass(this.options.itemClass) || nextItem[0] == this.currentItem[0] || nextItem[0] == this.helper[0]) {
